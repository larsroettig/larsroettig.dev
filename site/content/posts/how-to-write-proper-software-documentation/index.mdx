...
author: Lars Roettig
description:
  Is documentation essential or not, and what we should know about this topic. I share my knowledge to help you write better software documentation.
...
<blockquote className="relative p-4 text-xl italic">
    <p className="mb-4 font-serif">Well, we had to finish it quickly, and there was no time left for documentation.</p>
</blockquote>
...
<Callout>
 ...
 <a href="https://bethaitman.com/posts/tld-2019/" target="_blank" rel="nofollow noopener noreferrer">https://bethaitman.com/posts/tld-2019/</a>
</Callout>
...
<iframe width="100%" height="500" src="https://www.youtube-nocookie.com/embed/R6zeikbTgVc"

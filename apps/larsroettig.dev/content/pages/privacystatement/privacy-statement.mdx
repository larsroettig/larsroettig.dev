...
My website uses features of the CDN provider CloudFlare. Provider is CloudFlare, Inc. 665 3rd St. #200, San Francisco, CA 94107, USA. CloudFlare operates a content delivery network with DDOS protection features and DNS hosting. The data transfer between your browser and my server flows over CloudFlare's infrastructure and is analyzed there to fend off attacks. In order to protect my website from attacks and to distinguish legitimate traffic from attacks, CloudFlare may set cookies to enable you to access my websites. The use of CloudFlare is in the interest of a safe use of my website and the defense of harmful attacks from outside. This represents a legitimate interest in the sense of Art. 6 para. 1 lit. f DSGVO. CloudFlare with headquarters in the USA is certified for the US-European data protection agreement "Privacy Shield", which guarantees compliance with the data protection level applicable in the EU. Further information can also be found in the CloudFlare data protection declaration:
https://www.cloudflare.com/security-policy/

\_cflb cookie for Cloudflare Load Balancer session affinityThe cookie '\_\_cfduid' is set by the CloudFlare service to identify trusted web traffic. It does not match any user ID in the web application, nor does the cookie store any personally identifiable information https://support.cloudflare.com/hc/en-us/articles/200170156-What-does-the-CloudFlare-cfduid-cookie-do
